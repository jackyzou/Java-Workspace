...
public class VendingMachine extends JFrame
{
   ...
   private void createUserInterface()
   {
      ...
      a1IconJLabel.setIcon(new ImageIcon("cookie.png"));
      ...
      a2IconJLabel.setIcon(new ImageIcon("gum.png"));
      ...
      a3IconJLabel.setIcon(new ImageIcon("pretzel.png"));
      ...
      b1IconJLabel.setIcon( new ImageIcon( "pretzel.png" ) );
      ...
      b2IconJLabel.setIcon( new ImageIcon( "cookie.png" ) );
      ...
      b3IconJLabel.setIcon( new ImageIcon( "soda.png" ) );
