...
public class Transfer extends JFrame {
	...
	/////////////////////////////////////////////   
	   ...
	   private void createUserInterface()
	   {
	      ...
	      weekdaysJCheckBox.setBounds( 16,182, 120, 30  );
	      weekdaysJCheckBox.setText( "Weekdays" );
	      enterJPanel.add( weekdaysJCheckBox );
	      
	      
	      wholeWeekJCheckBox = new JCheckBox();
	      wholeWeekJCheckBox.setBounds( 16,217, 120, 30  );
	      wholeWeekJCheckBox.setText( "Whole week" );
	      ...
	      enterJButton.addActionListener(
	         ...
	         new ActionListener() // anonymous inner class
	         {
	            ...
	            //	amount = transferAmountJTextField.getText();
	            //	   transferHis = new TransferHistory();
	            	//  transferHis.setHistory(amount, );
	            }
	         }
	           );
