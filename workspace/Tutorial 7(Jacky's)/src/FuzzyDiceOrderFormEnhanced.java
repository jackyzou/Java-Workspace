...
public class FuzzyDiceOrderFormEnhanced extends JFrame
{
   ...
   public FuzzyDiceOrderFormEnhanced()
   {
      createUserInterface();
   }
   ...
   {
	   FuzzyDiceOrderFormEnhanced application = new FuzzyDiceOrderFormEnhanced();
