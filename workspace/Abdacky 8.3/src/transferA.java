...
public class transferA extends JFrame {
	   ...
	   private static JTextField balanceJTextField;
	/////////////////////////////////////////////   
	  ...
	  // private TransferHistory transferHis;
   	     ...
   	     public static void changeStuff(String u, double b)
   	     {
   	    	nameJTextField.setText(u);
   	    	balanceJTextField.setText(String.valueOf(b));
   	     }
...
///////////////////////////////BUG CHECK LETTERS/////////////////////	            	 
	            	...
	            	{
	            		MasterController.doTransfer(dough,ID);
	            	}
	            }
	            	catch(Exception x)
	            	{
	...
	public static void main(String[] args) {
		...
		transferA application = new transferA();
