				      ...
				      new ActionListener() 
				         {
				    	  private Object[] options;
				             public void actionPerformed ( ActionEvent event )
				             {
				            	 ...
				            	 String x = (String) JOptionPane.showInputDialog(null,"Search By User Name£º\n","Search",JOptionPane.PLAIN_MESSAGE,null,null, "Type in here");  
		    	            	  ...
		    	            	  else
		    	            	  {
		    	            		  ...
		    	            		  System.out.print("\n"+"Confirm");
						            	 ...
						            	 TextArea.setVisible(true);
						            	 scroller.setVisible(true);
						            	 userNameJLabel.setText("Search By UserName");
		    	            		     setVisible(false);
		    	            		  ...
		    	            		  {
		    	            				JOptionPane.showMessageDialog(null,"There's no such file:(", "ERROR", JOptionPane.PLAIN_MESSAGE);
		    	            		  }
		    	            	  }
		      ...
		      new ActionListener() 
		         {
		             ...
		             public void actionPerformed ( ActionEvent event )
		             {
		            	 ...
		            	 scroller.setVisible(false);
		            	 TextArea.setText("");
		            	 userNameJLabel.setText("CheckUserInfo");
		             }
