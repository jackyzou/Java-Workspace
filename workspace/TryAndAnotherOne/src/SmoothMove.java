...
public class SmoothMove extends JComponent implements ActionListener, KeyListener {
  ...
  void createAnimationImage() {
    ...
    if (useImage) {
      try {
        URL url = getClass().getResource("QQ20130502-3.png");
  ...
  private static void createAndShowGUI() {
    ...
    SmoothMove component = new SmoothMove();
    f.add(component);
    f.setVisible(true);
