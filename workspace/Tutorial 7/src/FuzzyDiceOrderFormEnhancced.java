...
public class FuzzyDiceOrderFormEnhancced extends JFrame
{
   ...
   public FuzzyDiceOrderFormEnhancced()
   {
      createUserInterface();
   }
   ...
   {
      FuzzyDiceOrderFormEnhancced application = new FuzzyDiceOrderFormEnhancced();
