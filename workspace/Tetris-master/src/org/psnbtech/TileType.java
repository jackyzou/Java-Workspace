...
public enum TileType {
	 ...
	 * Piece TypeU.
	 */
	TypeU(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX), 3, 3, 2, new boolean[][] {
		{
			false,	false,	false,
			true,	false,	true,
			true,	true,	true,
	 ...
	 * Piece TypeUi.
	 */
	TypeUi(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX), 4, 4, 1, new boolean[][] {
		{
	 ...
	 * Piece TypeiOi.
	 */
	TypeiOi(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX), 4, 4, 1, new boolean[][] {
		{
			false,	true,	true,	false,
			true,	true,	true,	true,
			false,	false,	false,	false,
	 ...
	 * Piece TypeStair.
	 */
	TypeStair(new Color(BoardPanel.COLOR_MIN, BoardPanel.COLOR_MAX, BoardPanel.COLOR_MAX), 5, 5, 1, new boolean[][] {
		{
