   ...
   // set up amJRadioButton
      ...
      periodJButton.addActionListener(
		         ...
		         new ActionListener() 
		         {
		             ...
		             public void actionPerformed ( ActionEvent event )
		             {
		            	 DateSlider myDateSlider = new DateSlider();
      ...
      dateJTextField.addMouseListener(new MouseAdapter(){
          ...
          {
        	  dateForInterest myDate =new dateForInterest();
          }
		             ...
		             public void actionPerformed ( ActionEvent event )
		             {
		            	if(pAndpButton.isSelected())
		            	{
		                  ...
		                  while(period>0 && period<=100)
		                  {
		                	  ...
		                	  while(rate<=100)
		                	  {
		                		  principal = principal*period*rate+principal;
		                		  
		                		  JOptionPane.showMessageDialog(null, "The total is " + principal + ".",
