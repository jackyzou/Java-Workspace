...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
		...
		if (evt.getPropertyName().equals("day")) {
			if (popup.isVisible()) {
				...
				if (((Integer)evt.getNewValue()).intValue() > 0) {
					...
					goDate(String.valueOf(jcalendar.getCalendar().getTime()));
				
					
					int k = JOptionPane.showConfirmDialog(null, 
            				"Your set off date is: "+ String.valueOf(jcalendar.getCalendar().getTime()) +"\n"
            				+ "Please Makse Sure to press the 'Update' button!"
							, "You Chose a Date sucessfully!", JOptionPane.YES_OPTION);
	...
	public static String comeDate() {
		return date;
	}

	public void goDate(String d) {
		date = d;
	}
