...
public class Transfer extends JFrame {
	   ...
	   private static JTextField dateJTF;
	   
	   private JButton transferHistory;
	   private TransferHistory transferHis;
	   static AccountHomePage ahp;
	   
	   private String balance;
	   
	   private String name,email,phone,address,password, type,fee;
   	     ...
   	     public void getAccountNum(String ANum)
   	     {
   	    	accountNumberJTextField.setText(ANum);
   	     }
   	     ...
   	     public void getFee(String f)
   	     {
   	    	 fee = f;
   	    	transferAmountJTextField.setText(fee);
   	     }
	   ...
	   private void createUserInterface()
	   {
	      ...
	      transferToJLabel.setText( "Name to Transfer To:" );
	      transferToJLabel.setBounds( 16,24, 140, 30);
	      enterJPanel.add( transferToJLabel );
	      
	      transferToJTextField = new JTextField();
	      transferToJTextField.setText( "TPS Collection Acc" );
	      ...
	      transferAmountJLabel.setText( "Money should be paid:" );
...
///////////////////////////////BUG CHECK LETTERS/////////////////////	            	 
	            	...
	            	{
	            		 JOptionPane.showMessageDialog( null, 
	            		            "You should fill out the date", "Error",
	            		            JOptionPane.ERROR_MESSAGE );
	            	}
	            	...
	            	{
	            		JOptionPane.showMessageDialog( null, 
            		            "You should check the work time", "Error",
            		            JOptionPane.ERROR_MESSAGE );
	            	}
	            	...
	            	transferHis.setHistory(dough, date, ID);//error is here
	            	double transferAmount = Double.parseDouble(transferAmountJTextField.getText());
	            	double balance1 = Double.parseDouble(balanceJTextField.getText());
	            	
	            	double newBalance = balance1 - transferAmount;
	            	balanceJTextField.setText(String.valueOf(newBalance));
	            	AccountHomePage ahp = new AccountHomePage();
	            	ahp.getBalanceFromTransfer(newBalance);
	            	ahp.setVisible(true);
	            	ahp.getUserBasicInfo1(name,email,phone,address,String.valueOf(newBalance), password,type);
	            	ahp.historyJTA("Transfer successfully!");
