...
public class EditUserInfo extends JFrame{
	...
	private JTextField nameJTextField, emailJTextField, phoneJTextField,genderJTextField, addressJTextField,countryJTextField;
	...
	private String name, email, phone, address,password,gender,country;
	private String balance;
	private String type;

	  AccountHomePage ahp = new AccountHomePage();
	private JLabel grass;
	private JComboBox genderJComboBox;
	...
	public void EditUserInfo(String name2, String email2,String pass2, String phone2,String address2,String gender2, String country2) {
	...
	private void createUserInterface()
	{
		...
		homePage.setBounds(0, -30, 175, 95 );
		...
		balanceJLabel = new JLabel("Your Country is:");
		...
		typeJLabel = new JLabel("Your Gender is:");
       ...
       // nameJTextfield.setText(name);
		...
		countryJTextField = new JTextField(country);
		//balanceJTextfield.setText(balance);
		countryJTextField.setBounds(200,278,150,30);
		countryJTextField.setEditable(false);
		contentPane1.add( countryJTextField );
	...
	balanceJButton = new JButton(new ImageIcon("QQ20130407-1.png"));
		...
		balanceJButton.addActionListener(
	    		  ...
	    		  new ActionListener()
	    		  {
					...
					{
						countryJTextField.setEditable(true); 
					}
	    		  }
					);
...
//////////////////////////Menu...\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
		...
		genderJComboBox.setBounds(190,313,185,40);
		contentPane1.add( genderJComboBox );
	    		  ...
	    		  new ActionListener()
	    		  {
					...
					private void submitJButtonActionPerformed(ActionEvent event) 
					{
						if(sureJCheckBox.isSelected())
						{
							...
							AHP.getUserBasicInfo(name,email,password,phone,address,gender,country);
							ah.getUserBasicInfo(name,email,password,phone,address,gender,country);
							ah.setVisible(true);
